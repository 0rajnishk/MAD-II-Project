...
class Song(db.Model):
    ...
    def serialize(self):
        return {
            ...
            'name': self.name,
            'user_id': self.user_id,
            'audio_file': self.audio_file.decode(),  # Convert LargeBinary to string
            'image': self.image.decode(),  # Convert LargeBinary to string
            'genre': self.genre,
            'date': self.date,
            'lyrics': self.lyrics,
            'singer': self.singer,
            ...
            'ratings': [rating.serialize() for rating in self.ratings],  # Assuming SongRating has a serialize method
            'comments': [comment.serialize() for comment in self.comments]  # Assuming Comment has a serialize method
        }
